        ...
        <ion-toolbar transparent class="ion-walkthrough-slide-buttons" [ngStyle]="{'order': isTopLayout() ? 3 : 1 }">
          ...
          <ion-buttons center>
            <button
              ion-button
              clear
              *ngIf="options.buttons && options.buttons.center"
              (click)="options.buttons.center.onClick()"
              [ngStyle]="options.buttons.center.textColor && {'color': options.buttons.center.textColor}"
              class="ion-walkthrough-slide-nav-button ion-walkthrough-slide-nav-button-center"
            >{{options.buttons.center.text}}</button>
          </ion-buttons>
